document.addEventListener('DOMContentLoaded', function() {
  ...
  function showSuccess(form, message) {
    const existingSuccess = form.querySelector('.form-message-success');
  ...
  function clearErrors(form) {
    ...
    const errorMessages = form.querySelectorAll('.form-error, .form-message-error, .form-message-success');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'fed4c055-4b33-4051-a0e1-d463cd20a693',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'fed4c055-4b33-4051-a0e1-d463cd20a693';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'fed4c055-4b33-4051-a0e1-d463cd20a693';
